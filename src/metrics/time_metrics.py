...
def get_time_stats(alb_instance, C=None):
    ...
    t_max_div_t_min = max_div_c/min_div_c
    ...
    return {'min_div_c': min_div_c, 'max_div_c': max_div_c, 't_max_div_t_min':t_max_div_t_min,'sum_div_c': sum_div_c, 'std_div_c': std_div_c, 't_cv':t_cv, 'ti_size':time_interval_size, 'avg_div_c':avg_div_c, 'lb_6':lb_6, 'lb_1':lb_1}
